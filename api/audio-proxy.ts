/**
 * 音频代理 Serverless Function
 *
 * GET /api/audio-proxy?url=<网易云 CDN 地址>
 *   绕过浏览器 CORS/ORB 限制,流式转发音频数据。
 *
 * dev 环境在 vite.config.ts(约 262-285 行)有对应代理,
 * 生产环境用本 serverless function,行为与 dev 代理一致(Referer/UA 头)。
 */
